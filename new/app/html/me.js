...
async function loadFriends() {
    ...
    try {
        ...
        const friends = Array.isArray(data === null || data === void 0 ? void 0 : data.friends) ? data.friends : [];
        ...
        try {
            ...
            if (invRes.ok && (invPayload === null || invPayload === void 0 ? void 0 : invPayload.ok) && Array.isArray(invPayload === null || invPayload === void 0 ? void 0 : invPayload.invites)) {
        ...
        function findInviteFromFriend(friendId) {
            const list = invites.filter((inv) => Number(inv === null || inv === void 0 ? void 0 : inv.from_id) === Number(friendId));
            if (list.length === 0)
                return null;
            list.sort((a, b) => Number((b === null || b === void 0 ? void 0 : b.created_at) || 0) - Number((a === null || a === void 0 ? void 0 : a.created_at) || 0));
            return list[0];
        }
        friends.forEach((f) => {
            ...
            if (inv === null || inv === void 0 ? void 0 : inv.code) {
                joinBtn.disabled = false;
                joinBtn.dataset.code = String(inv.code);
            ...
            inviteBtn.addEventListener("click", async (e) => {
                ...
                try {
                    ...
                    if (!res.ok || !(payload === null || payload === void 0 ? void 0 : payload.ok) || !(payload === null || payload === void 0 ? void 0 : payload.code)) {
                        setMessage((payload === null || payload === void 0 ? void 0 : payload.error) || "Invite failed.", true);
                        return;
                    }
            ...
            joinBtn.addEventListener("click", (e) => {
                ...
                e.preventDefault();
                e.stopPropagation();
                const code = String(((_a = joinBtn.dataset) === null || _a === void 0 ? void 0 : _a.code) || "").trim();
                if (!code) {
